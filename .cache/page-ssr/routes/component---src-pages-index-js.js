...
function Form() {
  const {
    0: email,
    1: setEmail
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""); //Form Email Value
  const {
    0: password,
    1: setPassword
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""); //Form Passowrd Value
  const {
    0: loading,
    1: setLoading
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false); //Login Loading Value
  const {
    0: error,
    1: setError
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null); //Form Error Value

  //Our form submission function
  const handleSubmit = async e => {
    e.preventDefault(); //Prevent regular form submission for testing purpose
    setLoading(true); //Update our login loading to be true
    setError(null); //Ensure our error state is null

    //Send our Axios Post Request
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("https://learngatsby.wpengine.com/graphql/", {
        //Send to GraphQL URL
        query: `
                ...
                `,
        //Our login form mutation
        variables: {
          username: email,
          //send our email state as the username
          password //send our password state as the password
        }
      });

      console.log("Login Success, AuthToken: ", response.data.data.login.authToken);
      //const { authToken } = response.data.data.login; //Get the authToken from the succesful response
      //localStorage.setItem("token", authToken); //Set our auth token to users local storage
    } catch (error) {
      var _error$response, _error$response$data, _error$response$data$, _error$response$data$2;
      //Catch any form errors
      console.error(error); //Log our error
      setError(((_error$response = error.response) === null || _error$response === void 0 ? void 0 : (_error$response$data = _error$response.data) === null || _error$response$data === void 0 ? void 0 : (_error$response$data$ = _error$response$data.errors) === null || _error$response$data$ === void 0 ? void 0 : (_error$response$data$2 = _error$response$data$[0]) === null || _error$response$data$2 === void 0 ? void 0 : _error$response$data$2.message) || "An error occurred"); //Update our error state for displaying to the user
    } finally {
      setLoading(false); //After everything is done set our loading state back to false
    }
  };

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("main", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, "Form"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("form", {
    onSubmit: handleSubmit
  }, error && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, error), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", null, "Email:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("input", {
    type: "email",
    value: email,
...
const IndexPage = () => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("main", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1", null, "Congratulations"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_Form_js__WEBPACK_IMPORTED_MODULE_1__.Form, null));
};
...
/* harmony import */ var _core_settle_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./../core/settle.js */ "./node_modules/axios/lib/core/settle.js");
/* harmony import */ var _core_buildFullPath_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../core/buildFullPath.js */ "./node_modules/axios/lib/core/buildFullPath.js");
/* harmony import */ var _helpers_buildURL_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./../helpers/buildURL.js */ "./node_modules/axios/lib/helpers/buildURL.js");
...
/* harmony import */ var _env_data_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../env/data.js */ "./node_modules/axios/lib/env/data.js");
/* harmony import */ var _defaults_transitional_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../defaults/transitional.js */ "./node_modules/axios/lib/defaults/transitional.js");
...
/* harmony import */ var _helpers_fromDataURI_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../helpers/fromDataURI.js */ "./node_modules/axios/lib/helpers/fromDataURI.js");
...
/* harmony import */ var _helpers_formDataToStream_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../helpers/formDataToStream.js */ "./node_modules/axios/lib/helpers/formDataToStream.js");
/* harmony import */ var _helpers_readBlob_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../helpers/readBlob.js */ "./node_modules/axios/lib/helpers/readBlob.js");
/* harmony import */ var _helpers_ZlibHeaderTransformStream_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../helpers/ZlibHeaderTransformStream.js */ "./node_modules/axios/lib/helpers/ZlibHeaderTransformStream.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (isHttpAdapterSupported && function httpAdapter(config) {
  return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
    ...
    // Parse url
    const fullPath = (0,_core_buildFullPath_js__WEBPACK_IMPORTED_MODULE_11__["default"])(config.baseURL, config.url);
    ...
    if (protocol === 'data:') {
      ...
      if (method !== 'GET') {
        return (0,_core_settle_js__WEBPACK_IMPORTED_MODULE_12__["default"])(resolve, reject, {
          status: 405,
      ...
      try {
        convertedData = (0,_helpers_fromDataURI_js__WEBPACK_IMPORTED_MODULE_13__["default"])(config.url, responseType === 'blob', {
      ...
      return (0,_core_settle_js__WEBPACK_IMPORTED_MODULE_12__["default"])(resolve, reject, {
        ...
        status: 200,
        statusText: 'OK',
        headers: new _core_AxiosHeaders_js__WEBPACK_IMPORTED_MODULE_15__["default"](),
        config
      });
    }
    ...
    const headers = _core_AxiosHeaders_js__WEBPACK_IMPORTED_MODULE_15__["default"].from(config.headers).normalize();

    // Set User-Agent (required by some servers)
    // See https://github.com/axios/axios/issues/69
    // User-Agent is specified; handle case where no UA header is desired
    // Only set header if it hasn't been set in config
    headers.set('User-Agent', 'axios/' + _env_data_js__WEBPACK_IMPORTED_MODULE_16__.VERSION, false);
    ...
    if (_utils_js__WEBPACK_IMPORTED_MODULE_8__["default"].isSpecCompliantForm(data)) {
      ...
      data = (0,_helpers_formDataToStream_js__WEBPACK_IMPORTED_MODULE_17__["default"])(data, (formHeaders) => {
        headers.set(formHeaders);
      }, {
        tag: `axios-${_env_data_js__WEBPACK_IMPORTED_MODULE_16__.VERSION}-boundary`,
      ...
      data = stream__WEBPACK_IMPORTED_MODULE_6__.Readable.from((0,_helpers_readBlob_js__WEBPACK_IMPORTED_MODULE_18__["default"])(data));
    ...
    if (data && (onUploadProgress || maxUploadRate)) {
      ...
      data = stream__WEBPACK_IMPORTED_MODULE_6__.pipeline([data, new _helpers_AxiosTransformStream_js__WEBPACK_IMPORTED_MODULE_19__["default"]({
    ...
    try {
      path = (0,_helpers_buildURL_js__WEBPACK_IMPORTED_MODULE_20__["default"])(
    ...
    req = transport.request(options, function handleResponse(res) {
      ...
      if (config.decompress !== false && res.headers['content-encoding']) {
        ...
        case 'x-compress':
          ...
          break;
        case 'deflate':
          streams.push(new _helpers_ZlibHeaderTransformStream_js__WEBPACK_IMPORTED_MODULE_21__["default"]());
      ...
      const response = {
        ...
        headers: new _core_AxiosHeaders_js__WEBPACK_IMPORTED_MODULE_15__["default"](res.headers),
        config,
        request: lastRequest
      };
      ...
      if (responseType === 'stream') {
        ...
        (0,_core_settle_js__WEBPACK_IMPORTED_MODULE_12__["default"])(resolve, reject, response);
      } else {
        ...
        responseStream.on('end', function handleStreamEnd() {
          try {
            ...
            reject(_core_AxiosError_js__WEBPACK_IMPORTED_MODULE_14__["default"].from(err, null, config, response.request, response));
          }
          (0,_core_settle_js__WEBPACK_IMPORTED_MODULE_12__["default"])(resolve, reject, response);
        });
      }
    ...
    if (config.timeout) {
      ...
      req.setTimeout(timeout, function handleRequestTimeout() {
        ...
        const transitional = config.transitional || _defaults_transitional_js__WEBPACK_IMPORTED_MODULE_22__["default"];
