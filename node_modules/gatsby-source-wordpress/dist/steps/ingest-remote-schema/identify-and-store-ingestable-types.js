...
const identifyAndStoreIngestableFieldsAndTypes = async () => {
  ...
  if (pluginOptions.type) {
    Object.entries(pluginOptions.type).forEach(([typeName, typeSettings]) => {
      ...
      if ((typeSettings.lazyNodes || (_pluginOptions$type = pluginOptions.type) !== null && _pluginOptions$type !== void 0 && (_pluginOptions$type$_ = _pluginOptions$type.__all) !== null && _pluginOptions$type$_ !== void 0 && _pluginOptions$type$_.lazyNodes) && !(0, _isExcluded.typeIsExcluded)({
        pluginOptions,
        typeName
      })) {
  ...
  for (const field of rootFields) {
    ...
    if ((0, _isExcluded.typeIsExcluded)({
      pluginOptions,
      typeName: (0, _helpers.findNamedType)(field.type).name
    })) {
      continue;
    }
    if (field.type.kind === `OBJECT`) {
      ...
      if (nodeField && (0, _helpers.findNamedType)(nodeField.type).kind === `INTERFACE`) {
        const nodeListField = type.fields.find(nodeListFilter);
        if (nodeListField) {
          var _pluginOptions$type2, _pluginOptions$type2$;
          if ((0, _isExcluded.typeIsExcluded)({
            typeName: (0, _helpers.findNamedTypeName)(nodeListField.type),
            pluginOptions
          })) {
            continue;
          }
          nodeInterfaceTypes.push((0, _helpers.findNamedTypeName)(nodeListField.type));
          _store.default.dispatch.remoteSchema.addFetchedType(nodeListField.type);
          const nodeListFieldType = typeMap.get((0, _helpers.findNamedTypeName)(nodeListField.type));
          for (const innerField of nodeListFieldType.fields) {
            if (!(0, _isExcluded.typeIsExcluded)({
              typeName: (0, _helpers.findNamedTypeName)(innerField.type),
              pluginOptions
            })) {
          ...
          !(pluginOptions !== null && pluginOptions !== void 0 && (_pluginOptions$type2 = pluginOptions.type) !== null && _pluginOptions$type2 !== void 0 && (_pluginOptions$type2$ = _pluginOptions$type2[(0, _helpers.findNamedTypeName)(nodeListField.type)]) !== null && _pluginOptions$type2$ !== void 0 && _pluginOptions$type2$.nodeInterface)) {
            const nodeInterfaceType = typeMap.get((0, _helpers.findNamedTypeName)(nodeListField.type));
            ...
            for (const type of (nodeInterfaceType === null || nodeInterfaceType === void 0 ? void 0 : nodeInterfaceType.possibleTypes) || []) {
              if (!(0, _isExcluded.typeIsExcluded)({
                typeName: (0, _helpers.findNamedTypeName)(type),
                pluginOptions
              })) {
        ...
        if (fieldBlacklist.includes(field.name) || (0, _isExcluded.typeIsExcluded)({
          typeName: (0, _helpers.findNamedType)(field.type).name,
          pluginOptions
        })) {
          continue;
    ...
    const takesIDinput = field === null || field === void 0 ? void 0 : (_field$args = field.args) === null || _field$args === void 0 ? void 0 : _field$args.find(arg => arg.type.name === `ID`);
    ...
    (_pluginOptions$type$R = pluginOptions.type.RootQuery) !== null && _pluginOptions$type$R !== void 0 && (_pluginOptions$type$R2 = _pluginOptions$type$R.excludeFieldNames) !== null && _pluginOptions$type$R2 !== void 0 && _pluginOptions$type$R2.find(excludedFieldName => excludedFieldName === field.name)) {
      continue;
    }
  ...
  for (const interfaceType of interfaces) {
    ...
    const typesThatImplementInterface = (0, _helpers.getTypesThatImplementInterfaceType)(interfaceType);
    const shouldSkipInterfaceType = !(0, _transformFields.transformFields)({
    ...
    if (interfaceType.fields) {
      for (const interfaceField of interfaceType.fields) {
        if (interfaceField.type && !(0, _isExcluded.typeIsExcluded)({
          typeName: (0, _helpers.findNamedType)(interfaceField.type).name,
          pluginOptions
        })) {
  ...
  const nodeListTypeNames = [...nodeInterfacePossibleTypeNames, ...nodeListRootFields.map(field => {
    ...
    return (0, _helpers.findNamedType)(nodesField.type).name;
  })];
