...
const customizeSchema = async ({
  ...
  remoteSchema.introspectionData.__schema.types.forEach(type => {
    if ((0, _helpers.fieldOfTypeWasFetched)(type) && !(0, _isExcluded.typeIsExcluded)({
      ...
      switch (type.kind) {
        case `UNION`:
          builtType = _buildTypes.default.unionType({
            ...typeBuilderApi,
            type
          });
          break;
        case `INTERFACE`:
          builtType = _buildTypes.default.interfaceType({
            ...typeBuilderApi,
            type
          });
          break;
        case `OBJECT`:
          builtType = _buildTypes.default.objectType({
            ...typeBuilderApi,
            type
          });
          break;
        case `ENUM`:
          builtType = _buildTypes.default.enumType({
            ...typeBuilderApi,
            type
          });
          break;
  ...
  const wpType = _buildTypes.default.objectType({
    ...typeBuilderApi,
    type: {
      kind: `OBJECT`,
  ...
  (0, _helpers.diffBuiltTypeDefs)(typeDefs);
